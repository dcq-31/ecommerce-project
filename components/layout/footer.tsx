...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-neutral-300 bg-white dark:border-neutral-700 dark:bg-neutral-950">
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center gap-1.5 px-4 py-8 min-[1320px]:px-0">
        ...
        <p className="text-[11px] tracking-wide text-neutral-400 dark:text-neutral-600">
          Hecho con ❤️
        </p>
      </div>
    </footer>
